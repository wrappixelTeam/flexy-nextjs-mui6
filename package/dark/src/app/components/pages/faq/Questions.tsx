import { Grid2 as Grid, Typography, Accordion, AccordionSummary, AccordionDetails, Divider } from '@mui/material';
      ...
      <Grid container spacing={3} justifyContent="center">
        <Grid
          ...
          <Accordion elevation={9}>
            ...
            <AccordionDetails>
              <Typography variant="subtitle1" pt={1} px={2} color="textSecondary">
                Wrappixel offers high-quality templates that are easy to use and fully customizable.
                With over 101,801 happy customers & trusted by 10,000+ Companies. Wrappixel is
          ...
          <Accordion elevation={9}>
            ...
            <AccordionDetails>
              <Typography variant="subtitle1" pt={1} px={2} color="textSecondary">
                ...
                product, Wrappixel gives you a 100% money back guarantee.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Grid>

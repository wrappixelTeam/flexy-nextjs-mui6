                        ...
                        <Box mb={3} bgcolor="warning.light" borderRadius="24px">
                            <Box px="20px" py="32px">
                                <Stack direction="column" spacing={2} mt={2} textAlign="center">
                                    ...
                                    <Typography variant="h4" fontWeight={700}>Light & Dark Colors</Typography>
                                    <Typography variant="body1" fontSize="15px">Choose your preferred visual style effortlessly.</Typography>
                                </Stack>
                            </Box>
                        </Box>
                    </Grid>
                        ...
                        <Box textAlign="center" mb={3} bgcolor="secondary.light" borderRadius="24px" overflow="hidden">
                            <Box px="20px" pt="26px" pb="20px">
                                <Stack direction="column" spacing={2} textAlign="center">
                                    ...
                                    <Typography variant="h4" fontWeight={700} px={1} lineHeight={1.4}>12+ Ready to Use Application Designs</Typography>
                                    <Typography variant="body1" fontSize="15px"> Instantly deployable designs for your applications.</Typography>
                        ...
                        <Box textAlign="center" mb={3} bgcolor="success.light" borderRadius="24px">
                            <Box px="20px" py="32px">
                                <Stack direction="column" spacing={2} mt={2} textAlign="center">
                                    ...
                                    <Typography variant="body1" fontSize="15px"> Benefit from continuous improvements.</Typography>
                                </Stack>
                            </Box>
                        </Box>
                    </Grid>
                        ...
                        <Box textAlign="center" mb={3} bgcolor="error.light" borderRadius="24px">
                            <Box px="20px" py="32px">
                                <Stack direction="column" spacing={2} mt={2} textAlign="center">
                                    ...
                                    <Typography variant="body1" fontSize="15px"> A rich collection for seamless user experiences.</Typography>
                                </Stack>
                            </Box>
                        </Box>
                    </Grid>

...
import { Grid2 as Grid, List, ListItem, ListItemIcon, ListItemText, Button, Paper } from '@mui/material';
    ...
    >
        <List dense component="div" role="list">
            {items.map((value) => {
                ...
                return (
                    <ListItemButton key={value} role="listitem" button onClick={handleToggle(value)}>
                        <ListItemIcon>
                                <CustomCheckbox
                                    tabIndex={-1}
                                    disableRipple

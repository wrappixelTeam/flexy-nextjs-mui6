          ...
          <CardContent>
            ...
            <Grid container spacing={3}>
              ...
              <Grid
                ...
                <CustomTextField id="text-baddress" variant="outlined" fullWidth />
              </Grid>
              <Grid
                size={{
                  xs: 12,
              ...
              <Grid
                ...
                <CustomTextField id="text-fname" variant="outlined" fullWidth />
              </Grid>
              <Grid
                size={{
                  xs: 12,
                ...
                <CustomTextField id="text-lname" variant="outlined" fullWidth />
              </Grid>
            </Grid>
          </CardContent>
        </BlankCard>
